...
from aerial_geoloc.data.university1652 import load_university1652_samples, resolve_university1652_root
...
def prepare_data_root(cfg: DataConfig) -> Path:
    ...
    elif cfg.dataset == "university1652":
        return resolve_university1652_root(root)
    return root
